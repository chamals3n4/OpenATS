...
export default function AssessmentPage() {
    ...
    async (reason?: string) => {
      ...
      try {
        ...
        const res = await apiFetch<{
          message: string;
          data: { passed: boolean; scorePercentage: number };
  ...
  const submitOnViolation = useCallback(
    (reason: string) => {
      if (screen !== "quiz") return;
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            This assessment link has expired. Please contact the hiring team for
            a new invitation.
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            <div>
              <p
                style={{ fontSize: 14, color: TEXT_MUTED, margin: "0 0 6px 0" }}
              >
                Hello,{" "}
            ...
            <button
              ...
              style={{
                width: "100%",
                height: 52,
                backgroundColor: starting ? "#94a3b8" : DARK,
                color: WHITE,
                border: "none",
                borderRadius: 12,
                fontSize: 15,
              ...
              <div style={{ textAlign: "right" }}>
                <p
                  style={{
                    fontSize: 22,
                    fontWeight: 700,
                    color: timeLeft < 120 ? "#ef4444" : TEXT_MAIN,
                    margin: 0,
                    lineHeight: 1,
                  }}
                >
