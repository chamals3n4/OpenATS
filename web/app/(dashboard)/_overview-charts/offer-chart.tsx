...
export function OfferChart({ data }: { data: { month: string; sent: number; accepted: number }[] }) {
  if (!data.length) return <p className="text-sm text-slate-400 p-8 text-center">No offer data yet.</p>;
  return (
