...
export default function ManageCandidatesPage() {
  ...
  const [selectedStatus, setSelectedStatus] = useState<"all" | "active" | "rejected">("all");
  ...
  const handleRowClick = (c: Candidate) => {
    router.push(`/candidates/${c.id}?from=candidates`);
  };
    ...
    <div className="flex flex-1 flex-col bg-white dark:bg-neutral-950">
      ...
      <div className="border-y border-slate-300 dark:border-neutral-700 px-8 py-3.5 flex items-center gap-4">
        ...
        <Select
          ...
          onValueChange={(value) =>
            setSelectedStatus(value as "all" | "active" | "rejected")
          }
        >
